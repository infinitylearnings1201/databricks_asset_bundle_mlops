...
# ``ml_ops_project/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-ml_ops_project-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops.ml_ops_project-model", label="Full (Three-Level) Model Name"
)
